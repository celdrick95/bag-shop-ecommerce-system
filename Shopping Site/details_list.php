...
?>
	<div class="h5 fw-bolder text-center">List of Bags</div>
	<hr>
	...
	?>
		<a class="list-group-item list-group-item-action" href="productPerList.php?pubid=<?php echo $row['publisherid']; ?>">
