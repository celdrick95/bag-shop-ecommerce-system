...
?>
	<div class="card rounded-0 shadow">
		...
		<div class="card-footer text-end">
			...
			<a href="products.php" class="btn btn-warning rounded-0">Continue Shopping</a>
...
<?php
		...
		?>
<div class="alert alert-warning rounded-0">Your cart is empty! Please add atleast 1 product to purchase first.</div>
<?php
