<?php
	...
	$result = getAll($conn);
?>
	<h4 class="fw-bolder text-center">Product List</h4>
	<center>
		...
		<div class="card-body">
			<div class="container-fluid">
				...
				<colgroup>
					...
					<tr>
						<td class="px-2 py-1 align-middle"><a href="product.php?bookisbn=<?php echo $row['book_isbn']; ?>" target="_blank"><?php echo $row['book_isbn']; ?></a></td>
