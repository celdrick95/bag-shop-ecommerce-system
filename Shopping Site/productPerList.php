...
<style>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="details_list.php" class="text-decoration-none text-muted fw-light">Categories</a></li>
...
?>
	<div class="row book-item mb-2">
		...
		<div class="col-md-9">
			...
			<a href="product.php?bookisbn=<?php echo $row['book_isbn'];?>" class="btn btn-primary">Get Details</a>
		</div>
	</div>
<?php
	}
